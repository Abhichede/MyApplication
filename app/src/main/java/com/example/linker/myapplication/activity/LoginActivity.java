...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public JSONObject authenticatedStudent = null;

    /**
     * Retrofit
     */
    public static final String BASE_URL = "http://schoolcon.herokuapp.com/";
            ...
            sessionApiService.getSession(email, email, password).enqueue(new Callback<SessionResponse>() {
                ...
                public void onResponse(Call<SessionResponse> call, Response<SessionResponse> response) {
                    ...
                    if(response.isSuccessful()){
                        ...
                        Log.d("Received", "MSG: " + response.message());

                        showProgress(false);
                        finish();
                        Intent mainActivityIntent = new Intent(getApplicationContext(), MainActivity.class);
                        mainActivityIntent.putExtra("session", authenticatedStudent.toString());
                        startActivity(mainActivityIntent);

                    }else{
                        Log.e("Error-retrofit level", "MSG: " + response.message());
                        showProgress(false);
