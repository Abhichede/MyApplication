...
public class Standard {
     ...
     * @param url
     */
    public Standard(int id, String name, String createdAt, String updatedAt, String url) {
        super();
        this.id = id;
        this.name = name;
    ...
    public Standard withCreatedAt(String createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Standard withUpdatedAt(String updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
